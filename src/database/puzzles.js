...
export const PUZZLES_DB = {
  ...
  'horse_password_puzzle': {
    type: 'sequence',
    id: 'horse_password_puzzle',
    loadingText: [
      'PAINEL DE SEGURANÇA — ÁREA RESTRITA',
      'Autenticação requerida para prosseguir.',
    ],
    promptText: ['SENHA DE ACESSO:'],
    correctPassword: ['jacaré'],
    successText: 'ACESSO CONCEDIDO. BEM-VINDA.',
    errorText: 'SENHA INCORRETA. ACESSO NEGADO.',
    solvedText: 'Acesso já concedido anteriormente.',
  },

  'owlbear_pckey_puzzle': {
    type: 'sequence',
    id: 'owlbear_pckey_puzzle',
    loadingText: [
      'TERMINAL DE SEGURANÇA — ÁREA RESTRITA',
      'Protocolo de autenticação de 4 etapas iniciado.',
    ],
    promptText: [
      'CÓDIGO 1/4:',
      'CÓDIGO 2/4:',
    ...
    correctPassword: ['branca', 'm0oon', '8756', 'petou'],
    successText: 'ACESSO TOTAL CONCEDIDO. SISTEMA DESBLOQUEADO.',
    errorText: 'CÓDIGO INCORRETO. TENTE NOVAMENTE.',
    solvedText: 'Sistema já desbloqueado.',
  },
